...
contract CrowdFund{
    ...
    struct Campaign {
        // kampanya yaratıcısı
        address creator;
        // yükseltilecek tokens miktarı
        uint goal;
        // Taahhüt edilen toplam tutar
        uint pledged;
